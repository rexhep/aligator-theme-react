  ...
  <Grid>
    <div
      css={[
        ...
        `,
        tw`col-span-6 md:col-span-6 lg:col-span-3 h-full relative flex items-center`,
      ]}
    >
      <div class="inner">
        <T.Body font="2">Peter Hsing</T.Body>
        <T.Body font="1">Let's work together</T.Body>
    ...
    <div
      css={[
        ...
        `,
        tw`col-span-6 md:col-span-6 lg:col-span-9 relative pl-3 md:pl-12 flex flex-col justify-center`,
      ]}
    >
