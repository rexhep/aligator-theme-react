          ...
          <article
            css={[
              css`
                ...
                background-color: ${teamMember.background || "#e5e7eb"};
                background-image: -webkit-gradient(
                  linear,
                  left top,
                  left bottom,
                  color-stop(10%, ${teamMember.background || "#f6004c"}),
                  to(#000)
                );
                background-image: -webkit-linear-gradient(
                  ${teamMember.background || "#f6004c"} 10%,
                  #000
                );
                ...
                // background: ${teamMember.background || "#e5e7eb"};
