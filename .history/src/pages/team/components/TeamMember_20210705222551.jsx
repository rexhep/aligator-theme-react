...
const TeamMember = ({ teamMember, setActiveTeamMember, teamMemberIndex }) => {
  ...
  console.log("teamMemberIndex", teamMemberIndex);
  return (
    <li
            ...
            css={[
              css`
                ...
                background: ${theme`colors`[
                  teamMember.backgroundColor || "red"
                ]};
              `,
          ...
          <article
            css={[
              css`
                ...
                background-color: ${teamMember.acf.color || "#e5e7eb"};
                background-image: -webkit-gradient(
                  linear,
                  left top,
                  left bottom,
                  color-stop(10%, ${teamMember.acf.color || "#f6004c"}),
                  to(#000)
                );
                background-image: -webkit-linear-gradient(
                  ${teamMember.acf.color || "#f6004c"} 10%,
                  #000
                );
