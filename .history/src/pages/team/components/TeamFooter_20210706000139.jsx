  ...
  <Grid>
    <div
      css={[
        ...
        `,
        tw`col-span-6 md:col-span-12 lg:col-span-6 h-full relative flex items-center`,
      ]}
    >
      <div
        class="inner"
    ...
    <div
      css={[
        ...
        `,
        tw`col-span-6 md:col-span-12 lg:col-span-6 relative pl-3 md:pl-12 flex flex-col justify-center`,
      ]}
    >
      {(isDesktop() && (
