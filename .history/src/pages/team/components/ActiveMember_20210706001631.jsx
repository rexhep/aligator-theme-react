...
const ActiveMember = ({
  ...
  <Grid node="section">
    ...
    <header css={[tw`col-span-12 md:col-span-8 md:col-start-3 mt-4 md:mt-0`]}>
      <T.Heading font="3" level="2">
        {activeTeamMember?.title || ``}
      </T.Heading>

      <T.Heading font="b1" styles={[tw`mt-4 mb-8 md:mb-0`]}>
    ...
    <div
      css={[
        css`
          ...
          font-weight: 300;
        `,
        tw`col-span-12 md:col-span-8 mt-4 mb-24 md:col-start-3 md:mb-64 text-base whitespace-pre-wrap`,
      ]}
