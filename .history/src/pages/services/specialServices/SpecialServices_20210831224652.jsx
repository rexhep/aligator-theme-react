...
import SpecialServicesHeader from "./components/SpecialServicesHeader";
import SpecialServicesList from "./components/SpecialServicesList";
import { servicesData } from "../servicesData";

const SpecialServicesPage = () => {
  const { isDesktop } = useContext(DocumentContext);

  const [expandedSpecialServ, setExpandedSpecialServ] = useState(null);
        ...
        <div css={[tw`relative mt-8 mb-32`]}>
          {specialServiceItems?.[0] && (
            <SpecialServicesList
              ...
              expandedSpecialServ={expandedSpecialServ}
              setExpandedSpecialServ={setExpandedSpecialServ}
              isDesktop={isDesktop}
            />
          )}
          <Grid>
