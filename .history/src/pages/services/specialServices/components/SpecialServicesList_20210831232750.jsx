  ...
  return (
    <ul css={[tw`relative`]}>
      {specialServiceItems[0].map((specialServ, specialServIndex) => {
        ...
        const active = expandedSpecialServ === specialServIndex;
          ...
          <li
            ...
            css={[
              css`
                ...
                color: ${active ? theme`colors.white` : theme`colors.blue.900`};
            ...
            <Grid>
              ...
              >
                <button
                  type="button"
                  onClick={() =>
                    setExpandedSpecialServ(active ? null : specialServIndex)
                  }
