              ...
              >
                {portfolioSectionItems.map(
                  (portfolioSectionItem, portfolioSectionItemIndex) => {
                    ...
                    if (portfolioSectionItem?.team_featured_media) {
                      logoImageJSX = (
                        <img
                          tw="w-full"
                          src={portfolioSectionItem.team_featured_media}
                          alt={portfolioSectionItem.title.rendered}
                        />
                      );
                    }
                    ...
                    const innerJSX = (
                      <>
                        ...
                        <T.Heading
                          ...
                          level="4"
                        >
                          {portfolioSectionItem.title.rendered}
                        </T.Heading>

                        <div>
                          {portfolioSectionItem?.content.rendered && (
                            <T.Body
                              font="3"
                              styles={[
                            ...
                            >
                              {portfolioSectionItem.acf.status}
                            </T.Body>
                          )}
                        </div>
                      </>
