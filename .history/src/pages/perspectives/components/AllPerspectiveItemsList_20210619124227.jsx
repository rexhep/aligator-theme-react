  ...
  return (
    ...
    >
        ...
        <Grid node="article" styles={[tw`relative items-center pb-8`]}>
          ...
          >
            ...
            {article?.acf?.author_name && (
              ...
              >
                {(isDesktop() && (
                  <T.Caption>{article.acf.author_name}</T.Caption>
                )) || <T.Body font="3">{article.acf.author_name}</T.Body>}
              </div>
            )}
            {isDeepDive && (
              <div
              ...
              >
                {(isDesktop() && <T.Caption>Deep Dive</T.Caption>) || (
                  <T.Body font="3">Deep Dive</T.Body>
                )}
              </div>
            )}
          </header>
      ...
      {visibleArticleCount === 1 && (
        <Grid node="article" styles={[tw`relative items-center`]}>
          <div
            css={[
              css`
                ...
                background-color: ${submitted
                  ...
                  : theme`colors.subscribe.color`};
                pointer-events: ${submitted || submitting ? `none` : `auto`};
              `,
          ...
          >
            <div
              css={[
                ...
                `,
                tw`w-full absolute top-0 right-0 left-0 bg-blue-900`,
              ]}
            />
            <SubscribeForm
              onSubmit={onSubmit}
...
export default AllPerspectiveItemsList;
