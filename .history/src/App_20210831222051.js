...
import ServicesLayout from "./pages/perspectives/index.jsx";
import MCxPage from "./pages/mcx/index.jsx";
import SpecialServicesPage from './pages/perspectives/deepDives/SpecialServices.jsx';
      ...
      <CursorProvider>
        <AppProvider>
          ...
          <Switch>
            ...
            <Route path="/perspectives/specialServices" exact>
              <SpecialServicesPage />
            </Route>
