...
const ArticleDetails = ({ data, location }) => {
  ...
  useEffect(() => {
    servicesData.filter((service) => service.slug === slug);
    // axios
    //   .get(
    ...
    //   .then((response) => {
    //     setPerspectives(
    //       response.data.filter((perspective) => perspective.slug === slug)
    //     );
  ...
  useEffect(() => {
    perspectives[0]?._embedded["wp:term"][0].map((catName) => {
      arrayCat.push(catName.name);
  ...
  const deepDives =
    perspectives[0]?._embedded["wp:term"][0][0].name === "Deep Dive";

  const articleTags = perspectives?.tags;
        ...
        >
          <Grid>
            ...
            >
              ...
              <div>
                {perspectives[0]?.acf?.author_name && (
                  <Go
                    inject={{
                      css: `
                ...
                >
                  <div
                    css={[
                      ...
                      `,
                      tw`w-full relative block pt-4 pr-3 pb-4 pl-3 bg-purple-900 text-white`,
                    ]}
                  >
              ...
              >
                <span
                  dangerouslySetInnerHTML={{
                    __html: perspectives[0]?.content.rendered,
                  }}
                />
              </T.Heading>
            </Grid>
          ...
          {deepDives && (
            <Grid>
              <div
                css={[
                  tw`col-span-full relative mt-12 pt-6 md:pt-6 pr-3 md:pr-6 pb-6 md:pb-6 pl-3 md:pl-6 bg-purple-900 text-white`,
                ]}
              >
                <T.Body font="2">
                  This article forms part of our Deep Dive on:
